import 'package:day_15_flutter/lableled_container.dart';
...
class FlexScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('ExpandedAndFlexible')),
        body: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ..._header(context, 'Expandede'),
  ...
  Widget _buildFooter(BuildContext context) {
    return Center(
      child: Container(
        ...
        child: Padding(
            padding: EdgeInsets.symmetric(vertical: 15.0, horizontal: 30,), child:Text("Pinned to the Bottom",style:Theme.of(context).textTheme.titleSmall ,) ,),
      ),
    );
  }
}
